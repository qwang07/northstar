...
| `implement` | implementation · scale-adaptive | turn red green (inline / subagent / team / workflow by scale) | implementation code | module-level exit gate self-issues the "contract conformance" check |
